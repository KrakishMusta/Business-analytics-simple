...
<template>
    ...
    <div class="flex flex-col px-5 sm:px-10 md:px-8 lg:px-10 box-border mt-10 w-full max-w-screen-2xl mx-auto">
        <div class="flex flex-col md:flex-row gap-6 md:gap-12 items-start md:items-center mb-6 text-gray-800">
            <button class="inline-flex justify-center items-center size-8 text-2xl bg-indigo-200 hover:bg-indigo-100 rounded">
