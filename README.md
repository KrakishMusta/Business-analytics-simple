# На данный момент сайт имеет неоптимизированную логику подгрузки данных для построения графиков и применения фильтров,
это сказывается на производительности устройства. Не еркомендуется посещать сайт на слабых устройствах.
